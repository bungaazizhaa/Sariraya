            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="slider-img"
                        style="background-image: url('{{ asset('assets/images/bannergrosser3.jpg') }}');">
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="slider-img"
                        style="background-image: url('{{ asset('assets/images/bannergrosser2.jpg') }}');">
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="txt">
                    ...
                    <div class="slider-img"
                        style="background-image: url('{{ asset('assets/images/bannergrosser1.jpg') }}');">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-lg-2 mb-lg-5 mx-lg-5 mx-sm-2 my-sm-2">
                <div class="col-sm-4 mt-3">
                    <div class="card mycard1 text-center">
                        <img class="card-img-top" src="{{ asset('assets/images/grosser1.jpg') }}" alt="Card image cap">

                    </div>
                </div>
                <div class="col-sm-4 mt-3">
                    <div class="card mycard1 text-center">
                        <img class="card-img-top" src="{{ asset('assets/images/grosser2.jpg') }}" alt="Card image cap">

                    </div>
                </div>
                <div class="col-sm-4 mt-3">
                    <div class="card mycard1 text-center">
                        <img class="card-img-top" src="{{ asset('assets/images/grosser3.jpg') }}" alt="Card image cap">
