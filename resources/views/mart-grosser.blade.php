    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="txt">
                    <h1 style="color: aliceblue;">Sariraya Wholesale</h1>
                    <p>Halal good selected quality food products <br>
                        with affordable price and good customer service.</p>
                </div>
                <div class="slider-img" style="background-image: url('{{ asset('assets/images/bannergrosser3.png') }}');">
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="slider-img" style="background-image: url('{{ asset('assets/images/bannergrosser2.png') }}');">
                </div>
            </div>
            <div class="carousel-item">
                <div class="txt">
                ...
                <div class="slider-img" style="background-image: url('{{ asset('assets/images/bannergrosser1.png') }}');">
                </div>
            </div>
        </div>
