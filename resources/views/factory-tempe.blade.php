    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="txt">
                    <h1 style="color: aliceblue;">Tempe Factory</h1>
                    <p>the only one making tempe in japan with the best material, <br>
                        for the best Indonesian taste.</p>
                </div>
                <img src="{{ asset('assets/images/bannertempe1.png') }}">
            </div>
            <div class="carousel-item">
                ...
                <img src="{{ asset('assets/images/bannertempe2.png') }}">
            </div>
            <div class="carousel-item">
                <div class="txt">
                    <h1 style="color: aliceblue;">Tempe Factory</h1>
                ...
                <img src="{{ asset('assets/images/bannertempe3.png') }}">
            </div>
        </div>
        ...
        <div class="row mb-lg-2 mb-lg-5 mx-lg-5 mx-sm-2 my-sm-2">
            <div class="col-sm-4 mt-3">
                <div class="card mycard1 text-center">
                    <img class="card-img-top" src="{{ asset('assets/images/temp1.png') }}" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">PRODUCT</h5>
                        <p>Sariraya tempe is packed in attractive packaging with orange color, with weight of each product 250g.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mt-3">
                <div class="card mycard1 text-center">
                    <img class="card-img-top" src="{{ asset('assets/images/temp2.png') }}" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">PRODUCTION</h5>
                        <p>Making tempe juice made in a factory with a very sophisticated, hygienic, and made directly by professionals.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mt-3">
                <div class="card mycard1 text-center">
                    <img class="card-img-top" src="{{ asset('assets/images/temp3.png') }}" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">DELIVERY</h5>
                        <p>Sariraya tempe has its own vehicle to distribute tempe to your place with its quality awake.</p>
                    </div>
                </div>
            </div>
        </div>
