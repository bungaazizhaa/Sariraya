    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="slider-img" style="background-image: url('{{ asset('assets/images/bannertempe1.png') }}');">
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="slider-img" style="background-image: url('{{ asset('assets/images/bannertempe2.png') }}');">
                </div>
            </div>
            <div class="carousel-item">
                <div class="txt">
                ...
                <div class="slider-img" style="background-image: url('{{ asset('assets/images/bannertempe3.png') }}');">
                </div>
            </div>
        </div>
