        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="slider-img" style="background-image: url('{{ asset('assets/images/pecel.jpg') }}');">
                    </div>
                </div>
            ...
            <div class="row pecel mb-lg-2 mb-lg-7 mx-lg-5 mx-sm-2 my-sm-2">
                <div class="col-sm-4 mt-3">
                    <div class="card mycard1 text-center">
                        <img class="card-img-top" src="{{ asset('assets/images/pecel1.jpg') }}" alt="Card image cap">

                    </div>
                </div>
                <div class="col-sm-4 mt-3">
                    <div class="card mycard1 text-center">
                        <img class="card-img-top" src="{{ asset('assets/images/pecel2.jpg') }}" alt="Card image cap">
