        ...
        <div class="row mx-2">
            <div class="col-12 col-md">
                ...
                <div class="social mb-3  d-flex justify-content-center">
                    ...
                    <img class="mx-3" src="{{ asset('assets/images/ig.png') }}" height="36px" alt="">
                    <img src="{{ asset('assets/images/fb.png') }}" height="36px" alt="">
                </div>
            </div>
            <div class="col-12 col-md">
                <h5 class=" text-light ">PRODUCTS</h5>
                <ul class="list-unstyled text-small">
                    <li><a class="text-white-50" href="#">Tempe Factory</a></li>
                    <li><a class="text-white-50" href="#">Halal Mart</a></li>
                    <li><a class="text-white-50" href="#">Online Shop</a></li>
                    <li><a class="text-white-50" href="#">Halal Fried Chiken</a></li>
                </ul>
            </div>
            <div class="col-12 col-md">
