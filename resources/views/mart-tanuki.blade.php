        ...
        <div class="row mb-lg-2 mb-lg-5 mx-lg-5 mx-sm-2 my-sm-2">
            <div class="col-sm-3 mt-3">
                <div class="card mycard1 text-center">
                    <img class="card-img-top" src="{{ asset('assets/images/tanuki1.jpg') }}" alt="Card image cap">

                </div>
            </div>
            <div class="col-sm-3 mt-3">
                <div class="card mycard1 text-center">
                    <img class="card-img-top" src="{{ asset('assets/images/tanuki2.jpg') }}" alt="Card image cap">

                </div>
            </div>
            <div class="col-sm-3 mt-3">
                <div class="card mycard1 text-center">
                    <img class="card-img-top" src="{{ asset('assets/images/tanuki3.jpg') }}" alt="Card image cap">

                </div>
            </div>
            <div class="col-sm-3 mt-3">
                <div class="card mycard1 text-center">
                    <img class="card-img-top" src="{{ asset('assets/images/tanuki4.jpg') }}" alt="Card image cap">
